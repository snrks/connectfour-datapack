...
scoreboard players operation @e[tag=connectfour_check,limit=1] connectfour_cache /= @e[tag=connectfour_register1] connectfour_cache
scoreboard players set @e[tag=connectfour_register2] connectfour_cache 16
scoreboard players operation @e[tag=connectfour_check,limit=1] connectfour_cache %= @e[tag=connectfour_register2] connectfour_cache
scoreboard players remove @e[tag=connectfour_register2] connectfour_cache 1
execute if score @e[tag=connectfour_check,limit=1] connectfour_cache = @e[tag=connectfour_register2,limit=1] connectfour_cache run tag @e[tag=connectfour_register2] add connectfour_success_vertical
